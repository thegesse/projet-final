...
class PlaylistController extends ChangeNotifier{
    ...
    PlaylistController(AuthController authController) : _playlistApi = PlaylistApi(authController);
    ...
    Future<bool> createPlaylist(String title) async {
        ...
        try{
            final playlist = await _playlistApi.createPlaylist(CreatePlaylistRequest(title: title),);
    ...
    Future<bool> renamePlaylist(int playlistId, String title) async {
        ...
        try{
            final renamed = await _playlistApi.renamePlaylist(playlistId, RenamePlaylistRequest(title: title),);
    ...
    Future<bool> addSongToPlaylist(int playlistId, Song song) async {
        ...
        try{
            final updated = await _playlistApi.addSongToPlaylist(playlistId, AddSongToPlaylistRequest(songId: song.id),);
    ...
    Future<bool> removeSongFromPlaylist(int playlistId, Song song) async {
        ...
        try {
            final updated = await _playlistApi.removeSongFromPlaylist(playlistId, RemoveSongFromPlaylistRequest(songId: song.id),);
